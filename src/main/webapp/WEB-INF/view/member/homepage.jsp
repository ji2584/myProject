        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <!-- Featured blog post-->
                    <div class="card mb-4">
                        <a href="#!"><img class="card-img-top" src="../images/hotel.jpg" alt="..." /></a>
                        <div class="card-body">
                            <div class="small text-muted">서울</div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <!-- Blog post-->
                            <div class="card mb-4">
                                <a href="#!"><img class="card-img-top" src="../images/seoulhotel.jpg" alt="..." /></a>
                                <div class="card-body">
                            ...
                            <!-- Blog post-->
                            <div class="card mb-4">
                                <a href="#!"><img class="card-img-top" src="../images/monogram.jpg" alt="..." /></a>
                                <div class="card-body">
                        ...
                        <div class="col-lg-6">
                            <!-- Blog post-->
                            <div class="card mb-4">
                                <a href="#!"><img class="card-img-top" src="../images/stay.jpg" alt="..." /></a>
                                <div class="card-body">
                                    <div class="small text-muted">작성날짜</div>
                                    <h2 class="card-title h4">이미지 제목</h2>
                                    <p class="card-text">이미지 부연설명</p>
                            ...
                            <!-- Blog post-->
                            <div class="card mb-4">
                                <a href="#!"><img class="card-img-top" src="../images/rewards.jpg" alt="..." /></a>
                                <div class="card-body">
                                    <div class="small text-muted">작성 날짜</div>
                                    <h2 class="card-title h4">이미지 제목</h2>
                                    <p class="card-text">이미지 부연설명</p>
